...
class Car:
    ...
    def returnLinRegMultiVarList(self):
        linRegList = []
        linRegList.append(float(self.Aantalcilinders))
        linRegList.append(float(self.Cilinderinhoud))
        linRegList.append(float(self.Massaleegvoertuig))
        linRegList.append(float(self.Vermogen))
        linRegList.append(float(self.Aantalcilinders) ** 2.0)
        linRegList.append(float(self.Cilinderinhoud) ** 2.0)
        linRegList.append(float(self.Massaleegvoertuig) ** 2.0)
        linRegList.append(float(self.Vermogen) ** 2.0)
        return linRegList
